...
*
* @example $('body').activity({'achieveTime':60,'testPeriod':10, useMultiMode: 1, callBack: function (e) { _gaq.push(['_trackEvent', 'Activity', '60 seconds', '60 seconds']); yaCounterXXXXXXXXX.reachGoal('60_sec'); }});
...
* _gaq.push(['_trackEvent', 'Activity', '60 seconds', '60 seconds']); для Google Analytics
